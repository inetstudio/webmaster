...
namespace InetStudio\Webmaster\Libraries\Webmaster;
...
class webmasterApi
{
     ...
     * Add new host
     *
     * Создание нового хоста. Параметром передается полный адрес хоста (лучше - с протоколом). Возвращается всегда объект,
